...
Pipe::Pipe(float inital_position, float gap_position, float gap_size,
  ...
  this->lower_pipe.setTextureRect(sf::IntRect({324, 1728}, {108, 239}));
  this->upper_pipe.setTexture(texture);
  this->upper_pipe.setTextureRect(sf::IntRect({324, 1728}, {108, 239}));
  ...
  this->lower_pipe.setScale({1.f, 2.f});
  this->upper_pipe.setScale({1.f, -2.f});
